          ...
          <div className="col-lg-5 col-12 ps-lg-60">
            <div>
              ...
              <p className="text-lg color-palette-1 mb-30">
                Kami menyediakan jutaan cara untuk <br className="d-sm-block d-none" /> membantu player menjadi
                <br className="d-sm-block d-none" /> pemenang sejati
              </p>
              <div className="d-md-block d-flex flex-column w-100">
                <a href="#" className="btn btn-read text-lg rounded-pill" role="button">Read Story</a>
              </div>
            </div>
          </div>    
         </div>
                        ...
                        <div className="row gap-sm-0">
                            <div className="col-md-4 col-6 mb-lg-0 mb-25">
                                ...
                                <ul className="list-unstyled">
                                    ...
                                    <li className="mb-6">
                                        <a href="" className="text-lg color-palette-1 text-decoration-none">Privacy dan
                                            Policy</a>
                                    </li>
                                </ul>
                            </div>
